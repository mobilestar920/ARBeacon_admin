                ...
                <div class="card card-login">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <button class="btn btn-info waves-effect waves-light" type="submit" style="color: #17a2b8 !important; background-color: white;">ログイン</button>
                        </div>
                        <div class="text-center" style="color: #ffffff;">
                            --------
                        </div>
                        <div class="text-center">
                        <a style="color: #17a2b8 !important;" href="{{ route('go_register') }}">登録</a>
                        </div>
                    </div>
                </div>
            </div>
